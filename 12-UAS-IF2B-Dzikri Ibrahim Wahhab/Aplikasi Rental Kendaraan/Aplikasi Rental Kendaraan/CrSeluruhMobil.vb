...
Public Class CrSeluruhMobil
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Rental_Kendaraan.CrSeluruhMobil.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrSeluruhMobil
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSeluruhMobil = New CrSeluruhMobil()
        rpt.Site = Me.Site
        Return rpt
    End Function
