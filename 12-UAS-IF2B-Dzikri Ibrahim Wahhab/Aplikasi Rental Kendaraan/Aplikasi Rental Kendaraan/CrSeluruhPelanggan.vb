...
Public Class CrSeluruhPelanggan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Rental_Kendaraan.CrSeluruhPelanggan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrSeluruhPelanggan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSeluruhPelanggan = New CrSeluruhPelanggan()
        rpt.Site = Me.Site
        Return rpt
    End Function
