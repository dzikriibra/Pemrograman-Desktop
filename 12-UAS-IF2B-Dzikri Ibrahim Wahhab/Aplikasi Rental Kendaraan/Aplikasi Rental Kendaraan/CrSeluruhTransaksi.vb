...
Public Class CrSeluruhTransaksi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Rental_Kendaraan.CrSeluruhTransaksi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Cari_ID_Transaksi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrSeluruhTransaksi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSeluruhTransaksi = New CrSeluruhTransaksi()
        rpt.Site = Me.Site
        Return rpt
    End Function
