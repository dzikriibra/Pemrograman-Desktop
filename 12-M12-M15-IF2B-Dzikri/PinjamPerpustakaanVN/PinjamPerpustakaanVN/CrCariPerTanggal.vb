...
Public Class CrCariPerTanggal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PinjamPerpustakaanVN.CrCariPerTanggal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TanggalPinjam() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrCariPerTanggal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrCariPerTanggal = New CrCariPerTanggal()
        rpt.Site = Me.Site
        Return rpt
    End Function
