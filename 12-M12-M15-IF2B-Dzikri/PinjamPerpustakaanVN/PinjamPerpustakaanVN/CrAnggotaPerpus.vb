...
Public Class CrAnggotaPerpus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PinjamPerpustakaanVN.CrAnggotaPerpus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrAnggotaPerpus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrAnggotaPerpus = New CrAnggotaPerpus()
        rpt.Site = Me.Site
        Return rpt
    End Function
