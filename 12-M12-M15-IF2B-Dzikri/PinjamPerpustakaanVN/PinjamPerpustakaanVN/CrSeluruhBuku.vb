...
Public Class CrSeluruhBuku
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PinjamPerpustakaanVN.CrSeluruhBuku.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrSeluruhBuku
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSeluruhBuku = New CrSeluruhBuku()
        rpt.Site = Me.Site
        Return rpt
    End Function
