...
Public Class CrCariPerBuku
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PinjamPerpustakaanVN.CrCariPerBuku.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Kode_Buku() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrCariPerBuku
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrCariPerBuku = New CrCariPerBuku()
        rpt.Site = Me.Site
        Return rpt
    End Function
